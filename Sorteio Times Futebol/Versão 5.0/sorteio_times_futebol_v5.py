...
jogadores_sorteio = [
    ...
    {'nome': 'Betinho', 'habilidade': 4, 'posicao_primaria': 'meia',
        'posicao_secundaria': 'zagueiro', 'adm': True},
    ...
    {'nome': 'Grimauro', 'habilidade': 2.5, 'posicao_primaria': 'zagueiro',
        'posicao_secundaria': 'atacante', 'adm': False},
    {'nome': 'Juninho', 'habilidade': 3, 'posicao_primaria': 'zagueiro',
        'posicao_secundaria': 'nenhum', 'adm': False},
    ...
    {'nome': 'Neto', 'habilidade': 3.5, 'posicao_primaria': 'atacante',
        'posicao_secundaria': 'nenhum', 'adm': False},
    {'nome': 'Túlio', 'habilidade': 3.5, 'posicao_primaria': 'zagueiro',
        'posicao_secundaria': 'meia', 'adm': False},
    {'nome': 'Xandinho', 'habilidade': 1, 'posicao_primaria': 'atacante',
        'posicao_secundaria': 'zagueiro', 'adm': False},
    {'nome': 'Renan', 'habilidade': 5, 'posicao_primaria': 'atacante',
        'posicao_secundaria': 'meia', 'adm': False},
    {'nome': 'Flavio U.', 'habilidade': 4.5, 'posicao_primaria': 'meia',
        'posicao_secundaria': 'atacante', 'adm': False},
    {'nome': 'Arthur', 'habilidade': 3, 'posicao_primaria': 'qualquer',
        'posicao_secundaria': 'nenhum', 'adm': False},
    {'nome': 'Lucas', 'habilidade': 5, 'posicao_primaria': 'meia',
        'posicao_secundaria': 'atacante', 'adm': False},
    {'nome': 'Gabriel', 'habilidade': 2, 'posicao_primaria': 'meia',
        'posicao_secundaria': 'atacante', 'adm': False},
    {'nome': 'Serginho', 'habilidade': 3, 'posicao_primaria': 'qualquer',
        'posicao_secundaria': 'nenhum', 'adm': False},
